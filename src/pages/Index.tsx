...
const faq = [
  ...
  { q: 'Что будет на пробном уроке?', a: 'Ребёнок создаст свой первый мини-проект, а родители увидят формат обучения изнутри. Урок бесплатный.' },
        ...
        <div className="container grid md:grid-cols-2 gap-12 items-center relative">
          <div className="animate-fade-up">
            ...
            <div className="flex gap-8 mt-10">
              {[['до 4', 'детей в группе'], ['3', 'направления'], ['1-й', 'урок бесплатно']].map(([n, l]) => (
                <div key={l}>
